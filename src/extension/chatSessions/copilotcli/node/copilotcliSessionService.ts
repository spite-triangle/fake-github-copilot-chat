...
import type { AutoModeSessionResult, internal, LocalSession, LocalSessionMetadata, AutoModeSessionManager as SDKAutoModeSessionManager, Session, SessionContext, SessionEvent, SessionOptions, SweCustomAgent } from '@github/copilot/sdk';
