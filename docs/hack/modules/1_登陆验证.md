...
- 构造函数修改如下，同时删除未使用的导入 `import { ChatExtGlobalPerfMark, markChatExtGlobal } from '../../../util/common/performance';`
...
- 函数 `getAuthSession` 修改如下，同时删除未使用的导入 `import { mixin } from '../../../util/vs/base/common/objects';` 和 `import { URI } from '../../../util/vs/base/common/uri';`
...
- 方法 `doAuthFromGitHubTokenOrDevDeviceId` 修改如下，同时删除未使用的导入 `import { TelemetryData } from '../../telemetry/common/telemetryData';`
